            ...
            <div>
                ...
                <div className="PageContent__wrapper">
                    ...
                    <ArticlePreview
                        ...
                        imageSizes={data.vectorLiftingRadiesseArticle.fluid}
                        description={
                    ...
                    <ArticlePreview
                        ...
                        imageSizes={data.laserCarbonPeelingArticle.fluid}
                        description={
                    ...
                    <ArticlePreview
                        ...
                        imageSizes={data.dermafilHappyLiftThreadsArticle.fluid}
                        description={''}
                        type={'article'}
                    />
                    <ArticlePreview
                    ...
                    <ArticlePreview
                        ...
                        imageSizes={data.laserPigmentSpotRemovalArticle.fluid}
                        description={''}
                        type={'article'}
                    />
                    <ArticlePreview
                        ...
                        imageSizes={
                            data.laserRejuvenationAdvantagesArticle.fluid
                        }
                        description={''}
                        type={'article'}
                    />
                    ...
                    <ArticlePreview
                        ...
                        imageSizes={data.ritidectomyFaceliftingArticle.fluid}
                        description={''}
                        type={'article'}
                    />
                    <ArticlePreview
                        ...
                        imageSizes={data.silhouetteLiftSoftThreadsArticle.fluid}
                        description={''}
                        type={'article'}
                    />
                    <ArticlePreview
