                ...
                <div>
                    ...
                    >
                        <Slider>
                            <Slide index={0}>
                                <SliderItem
                                    imageSizes={data.indexSlideBeauty.fluid}
                                    title={'КРАСОТА'}
                                    align="right"
                                    color="#924d45"
                                />
                            ...
                            <Slide index={1}>
                                <SliderItem
                                    imageSizes={data.indexSlideYouth.fluid}
                                    title={'МОЛОДОСТЬ'}
                                    align="left"
                                    color="#fff"
                                />
                            ...
                            <Slide index={2}>
                                <SliderItem
                                    imageSizes={data.indexSlideQuality.fluid}
                                    title={'КАЧЕСТВО'}
                                    align="right"
                                    color="#f7dfd5"
                                />
                            ...
                            <Slide index={3}>
                                <SliderItem
                                    imageSizes={data.indexSlideFreshness.fluid}
                                    title={'СВЕЖЕСТЬ'}
                                    align="left"
                                    color="#7ba310"
                                />
                    ...
                    >
                        ...
                        пациенту, что выражается в разработке плана лечения,
                        подборе и использовании комплекса процедур и препаратов,
                        нацеленных на решение конкретной проблемы, поддержке и
                        ведении пациента в дальнейшем.
                    </p>
                    ...
                    >
                        ...
                        наиболее щадящие, безболезненные и эффективные методики,
                        а также стремятся предпринять превентивные меры для
                        предотвращения возникновения проблем в будущем.
                        Безопасность при проведении процедур и дальнейшем
                        сопровождении пациентов — это непременное условие
                        качественной работы нашей клиники!
                    </p>
