        ...
        <Layout>
            <div>
                ...
                <div className="PageContent__wrapper">
                    <InfoBlock color="red">
                        <p>
                            Всем пациентам необходимо иметь при себе документы.
                            Заполнение медицинской документации{' '}
                            <b>обязательно</b> до выполнения любой медицинской
                            процедуры. Без заполнения мед. документации врач{' '}
                            <b>не имеет права</b> осуществлять приём пациента!
                        </p>
                    </InfoBlock>
